    ...
    return datasets.map((dataset, index) => {
        ...
        if (['doughnut', 'pie', 'polarArea'].includes(type)) {
            return {
                ...
                borderColor: dataset.borderColor || '#131d31',
    ...
    return {
        ...
        plugins: {
            legend: {
                ...
                align: 'end',
                labels: { color: '#94a3b8', boxWidth: 10, boxHeight: 10, usePointStyle: true, padding: 16 },
            },
            tooltip: {
        ...
        scales: radial ? undefined : {
            x: {
                grid: { display: horizontal, color: 'rgba(148, 163, 184, 0.09)' },

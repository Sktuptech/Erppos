...
<?php else: ?>
    ...
    <section class="pos-layout" data-pos data-products-endpoint="pos/products" data-checkout-endpoint="pos/sales" data-currency="<?= Helpers::escape($currencyCode) ?>" data-storage-key="karoor-pos-cart-<?= (int) $openSession['id'] ?>">
        ...
        <aside class="surface-card" aria-label="Current sale">
            <div class="card-header-row"><div><h2>Current sale</h2><p><span data-pos-count>0</span> product lines · <span data-pos-quantity>0</span> units</p></div><button class="btn btn-sm btn-outline-danger" type="button" data-pos-clear><i class="fa-solid fa-trash" aria-hidden="true"></i> Clear</button></div>
            <div class="card-body-pad">
